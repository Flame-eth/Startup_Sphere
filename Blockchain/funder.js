...
var contractAddress = "0x07757DFd77b4E022489F4fA5F77a76C06b5EEECD";
...
var result = (0, exports.getAllProposals)();
console.log(result);
var getProposal = function (proposalID) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.getProposal(proposalID).call()];
        case 1:
          proposal = _a.sent();
