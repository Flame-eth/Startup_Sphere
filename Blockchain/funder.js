...
console.log(result);
var getProposal = function (proposalID) { return __awaiter(void 0, void 0, void 0, function () {
    var proposal;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, contract.methods.getProposal(proposalID).call()];
            case 1:
                proposal = _a.sent();
