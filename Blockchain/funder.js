...
exports.verifyVoter =
  ...
  exports.getMyProposal =
  exports.setRequiredVotesPercentage =
  exports.removeVoter =
  exports.addVoter =
  exports.getFundersCount =
  exports.getVoterCount =
  exports.getProposalCount =
  exports.getRequiredVotesPercentage =
  exports.getRequiredVotes =
  exports.getVoters =
  exports.getProposalIDs =
  exports.getFunders =
  exports.refundFunders =
  exports.withdrawFunds =
  exports.getProposalVotes =
  exports.fundProposal =
  exports.vote =
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            contract.methods.transferOwnership(newAdmin).send,
          ];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            contract.methods.createProposal(
              name,
              description,
              projectCID,
              goalAmountWei,
...
var vote = function (proposalID) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.vote(proposalID).send];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
exports.vote = vote;
var fundProposal = function (proposalID, amount) {
  return __awaiter(void 0, void 0, void 0, function () {
    var amountWei, tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            contract.methods.fundProposal(proposalID).send({
              value: amountWei,
            }),
          ];
        case 1:
...
var getProposalVotes = function (proposalID) {
  return __awaiter(void 0, void 0, void 0, function () {
    var votes;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            contract.methods.getProposalVotes(proposalID).call(),
          ];
        case 1:
          votes = _a.sent();
...
var withdrawFunds = function (proposalID) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.withdrawFunds(proposalID).send];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var refundFunders = function (proposalID) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.refundFunders(proposalID).send];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var getFunders = function (proposalID) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.getFunders(proposalID).call()];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var getProposalIDs = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.getProposalIDs().call()];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
(0, exports.getProposalIDs)().then(function (res) {
...
var getVoters = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.getVoters().call()];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var getRequiredVotes = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.getRequiredVotes().call()];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var getRequiredVotesPercentage = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            contract.methods.getRequiredVotesPercentage().call(),
          ];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
...
var getProposalCount = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.getProposalCount().call()];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var getVoterCount = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.getVoterCount().call()];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var getFundersCount = function (proposalID) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            contract.methods.getFundersCount(proposalID).call(),
          ];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
...
var addVoter = function (voter) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.addVoter(voter).send];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var removeVoter = function (voter) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.removeVoter(voter).send];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
1;
var setRequiredVotesPercentage = function (percentage) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            contract.methods.setRequiredVotesPercentage(percentage).send,
          ];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
...
var getMyProposal = function (user) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.getMyProposal(user).call()];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var getTotalProposals = function (index) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.proposalsArray(index).call()];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
...
var verifyVoter = function (voter) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tx;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, contract.methods.isVoter(voter).call()];
        case 1:
          tx = _a.sent();
          return [2 /*return*/, tx];
      }
